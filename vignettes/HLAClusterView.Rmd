...
We used the first HLA typing field, which designates the allele type based on genetic similarity, to define a Hamming like distance. The metic is define as the minimal differing allele type sums 

<br>

<center>

![](Hamming_Eqn_01.jpg ""){width=85%}
...
### 4. Calculating similarity metric

The Hamming distance, which is based on first HLA typing field, can be 
