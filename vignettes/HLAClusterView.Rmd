...
As the *draw_heatmap()* function enable personalization by acception parameters
that are pass to the interanl *Heatmap()* function from 
...
draw_heatmap(hammingMetric, col = col_fun, border = TRUE,
...
### Cluster dendogram using Hamming-like metric

The *draw_dendogram()* function enable the creation of a cluster dendogram 
graph.

```{r clusteringHamming, warning=FALSE, message=FALSE}
